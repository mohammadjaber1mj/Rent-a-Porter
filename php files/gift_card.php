        ...
        <div class="row" style="margin-top: 3rem;">
            <div class="col">
                <div class="col text-start">
                    <form action="card_checkout_1.php" method="POST">
                        <div class="form-group">
                            <label for="RName" class="gift_label">Recipient's name *</label>
                            <input class="gift_in" required="" name="recipient_name" id="RName" type="text" required>
                        </div>
                        <div class="form-group">
                            <label for="REmail" class="gift_label">Recipient's email *</label>
                            <input class="gift_in" required="" name="recipient_email" id="REmail" type="email" required>
                        </div>
                        <div class="form-group">
                            <label for="GiftAmount" class="gift_label">Gift amount (USD) *</label>
                            <input class="gift_in" required="" name="amount" id="GiftAmount" type="number" required>
                        </div>
                        <div class="form-group">
                            <label for="GiftMessage" class="gift_label">Message *</label>
                            <input class="gift_in" required="" name="message" id="GiftMessage" type="text" required>
                        </div>
                        <div class="form-group">
                            <label for="UserName" class="gift_label">Your name *</label>
                            <input class="gift_in" required="" name="user_name" id="UserName" type="text" required>
                        </div>
                        <p>Valid one year from date of purchase.</p>
                        <div class="form-group">
                            <input class="gift_in" value="CONFIRM" type="submit">
                        </div>
                    </form>
                </div>
            </div>
            <div class="col" style="margin-left: 3rem;">
                <h4 style="color: #E7687D;">Looking for the perfect gift?</h4>
                <br>
                <h5>Spoil your loved one with a Rent a Porter gift card.<br> Ideal for all occasions, this gift card allows your<br> special person to indulge in our endless designer closet.</h5>
                <br><br><br>
                <img src="images/gift_card_1.png" alt="" width="620px">
            </div>
