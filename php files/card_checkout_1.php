...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Store each POST data in session variables
            ...
            <div class="col-6" style="margin-top: 7rem;">
                <div class="sign_div">
                    <div class="form-container" style="width: 600px;">
                        ...
                        <form action="card_checkout_2.php" method="POST">
                            <div class="row">
                                <div class="col">
                            ...
                            <div id="delivery_info" style="display:none;">
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    echo "<a href='card_edit_user_address.php' class='button_become_a_lender'>Edit</a>";
