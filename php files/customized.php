        ...
        <div class="row" style='margin-top: 1rem;'>
            <div class="col">
                <div class="row row-cols-3">
                    <?php
                    $sql = "SELECT * FROM `dresses` WHERE designer_id='7';";
            ...
            <div class="col-4" style="margin-top: 2rem;">
                <h5>DESIGN YOUR DREAM DRESS</h5>
                <br>
                <h6>YOU CAN BOOK AN APPOINTMENT WITH OUR DESIGNERS</h6>
                <br>
                <p>1. SEND YOUR INSPIRATION</p>
                <p>2. MEET OUR DESIGNERS</p>
                <p>3. HAVE YOUR DRESS READY</p>
                <p>4. OH AND PUT IT FOR RENTAL</p>
                <br>
                <h6>CONTACT US NOW<br>WE ARE HERE FOR YOU</h6>
                <p>view our contact information<br> and socials at the bottom.</p>
            </div>
        </div>
    </div>
