...
<body style="display: flex; flex-direction: column; min-height: 100vh;">
    ...
    <div class="container text-center">
        <div class="row row-cols-3" style='margin-top: 1rem;'>
            ...
            $dresses_result = mysqli_query($DBConnect, "SELECT * FROM dresses, designers WHERE dresses.designer_id='$designer_id' AND dresses.designer_id=designers.designer_id");
            if (mysqli_num_rows($dresses_result) > 0) {
                ...
                $des_sql = mysqli_query($DBConnect, "SELECT name FROM designers WHERE designer_id=$designer_id");
                if ($des_row = mysqli_fetch_assoc($des_sql)) {
                    $name = $des_row['name'];
                    echo "<div class='col-12' style='margin-top: 2rem;'>";
                    echo "<h4 style='margin-top: 7rem;'>No dresses available by " . $name . ".</h4>";
                    echo "</div>";
                }
            }
