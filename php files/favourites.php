...
<body style="display: flex; flex-direction: column; min-height: 100vh;">
    ...
    <div class="container text-center" style="margin-bottom: 2rem;">
        ...
        while ($row = mysqli_fetch_array($result)) {
            $fav_dress_code = $row["dress_code"];
            $fav_dresses_sql = "SELECT * FROM `dresses`, designers WHERE dresses.designer_id=designers.designer_id AND dress_code = $fav_dress_code";
            $fav_dresses_result = mysqli_query($DBConnect, $fav_dresses_sql);
            while ($row = mysqli_fetch_array($fav_dresses_result)) {
                echo "<div class='row' style='margin-top: 1rem;'>
                        ...
                        <div class='col'>
                            <button type='submit' class='fav_btn' style='font-size: 15px; margin-top: 1rem;'><a href='dress_details.php?dress_code=" . $row['dress_code'] . "' style='text-decoration: none; color: white;'>ADD TO CART</a></button>
                        </div>
                        <div class='col'>
                            <form method='POST' action='user_delete_favourite.php'>
