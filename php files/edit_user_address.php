...
if (isset($_POST['submit'])) {
    ...
    $update_sql = "UPDATE `user_address` SET `country` = '$country', `city` = '$city', `street` = '$street', `building` = '$building', `floor` = '$floor' WHERE `user_id` = '$user_id'";
                ...
                <div class="sign_div">
                    <div class="form-container" style="width: 600px;">
                        ...
                        <div style="position: relative; border: 2px solid black;">
                            <span class="close-button" onclick="closeAddressPopup()" style="position: absolute; top: 0; right: 10px; cursor: pointer;">&times;</span>
                        ...
                        <br>
                        <a href="user_checkout_1.php"><button class="form-btn">NEXT</button></a>
                    </div>
                </div>
            </div>
            <div class="col">
...
<script>
    function closeAddressPopup() {
        window.location.href = 'user_checkout_1.php';
    }
</script>